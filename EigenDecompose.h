...
namespace Eigen34 
{
  ...
  std::vector<P> GaussJordan3x3( std::vector<P> flat_mat)
  {
    ...
    if (index1 == 0)
    {
      ...
      listFinalCoef[0] = flat_mat[1]; listFinalCoef[1] = flat_mat[2];
    ...
    else if (index1 == 1)
    {
      ...
      pX[0] = &x2; pX[1] = &x1; pX[2] = &x3;

      listFinalCoef[0] = flat_mat[0]; listFinalCoef[1] = flat_mat[2];
    ...
    else if (index1 == 2)
    {
      ...
      pX[0] = &x3; pX[1] = &x1; pX[2] = &x2;

      listFinalCoef[0] = flat_mat[0]; listFinalCoef[1] = flat_mat[1];
    ...
    else if (index1 == 3)
    {
      ...
      listFinalCoef[0] = flat_mat[4]; listFinalCoef[1] = flat_mat[5];
    ...
    else if (index1 == 4)
    {
      ...
      listFinalCoef[0] = flat_mat[3]; listFinalCoef[1] = flat_mat[5];
    ...
    else if (index1 == 5)
    {
      ...
      listFinalCoef[0] = flat_mat[3]; listFinalCoef[1] = flat_mat[4];
    ...
    else if (index1 == 6)
    {
      ...
      listFinalCoef[0] = flat_mat[7]; listFinalCoef[1] = flat_mat[8];
    ...
    else if (index1 == 7)
    {
      ...
      listFinalCoef[0] = flat_mat[6]; listFinalCoef[1] = flat_mat[8];
    ...
    else if (index1 == 8)
    {
      ...
      listFinalCoef[0] = flat_mat[6]; listFinalCoef[1] = flat_mat[7];
  ...
  {	
    ...
    std::vector<P> A;
    A.push_back(M[0] - lambda); A.push_back(M[1]); 		      A.push_back(M[2]); 		A.push_back(M[3]);
    A.push_back(M[4]); 		A.push_back(M[5] - lambda); 	      A.push_back(M[6]); 		A.push_back(M[7]);
    A.push_back(M[8]); 		A.push_back(M[9]); 		      A.push_back(M[10] - lambda); 	A.push_back(M[11]);
    A.push_back(M[12]); 	A.push_back(M[13]); 	      	      A.push_back(M[14]); 		A.push_back(M[15] - lambda);
  ...
  {	
    ...
    // Now obtaining a vector containing the M-lambda * eye(3)
    std::vector<P> A;
    A.push_back(M[0] - lambda); A.push_back(M[1]); 		      A.push_back(M[2]); 		
    A.push_back(M[3]); 		A.push_back(M[4] - lambda); 	      A.push_back(M[5]);
    A.push_back(M[6]); 		A.push_back(M[7]); 		      A.push_back(M[8] - lambda); 	
  ...
  {	
    ...
    if (eigenvalues.size() == 0) return std::pair< std::vector<P>, std::vector<std::vector<P>> >(eigenvalues, eigenvectors) ;
    ...
    for (int i = 0; i < eigenvalues.size(); i++)
    {
      ...
      A[0] -= eigenvalues[i]; A[4] -= eigenvalues[i]; A[8] -= eigenvalues[i]; 
  ...
  {	
    ...
    {
      // Now subtract the eigenvalue from the diagonal
      A[0] -= eigenvalues[i]; A[5] -= eigenvalues[i]; A[10] -= eigenvalues[i]; A[15] -= eigenvalues[i];
